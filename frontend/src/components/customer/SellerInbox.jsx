...
import { deleteConversation } from '../../features/conversation/consversationSlice';
        ...
        <div className="seller-inbox-wrapper d-flex flex-column justify-content-between">
            <div className="d-flex w-100 justify-content-between align-items-center bg-gray p-2">
                ...
                <div className=" d-flex gap-10">
                    ...
                    <button className="btn btn-success d-flex align-items-center gap-2" onClick={() => setOpen(false)}>
                        <IoArrowBackSharp />
                    </button>
                </div>
            </div>
